    ...
    public partial class Edit_Guarantees : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dt_guaran = obj_cond.get_guaranteeinfo_edit(client_no, cpno, id);
        ...
        protected void btnupdatedata_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    && flnetworthguaran.Text != "")
                {
                    ...
                    client_no = "21116";
                    id = Convert.ToInt32(Request.QueryString["Id"]);
                    vstatus = obj_cond.Update_Guarantees(client_no, cpno, id, Convert.ToInt32(hdfbrwr_type.Value.ToString()), txtguarantorname.Text, txttowhom.Text,
